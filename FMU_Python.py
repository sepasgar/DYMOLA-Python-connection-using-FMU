...
def test_sim():
    ...
    # GETTING THE VALUE REFERENCES FOR THE VARIABLES YOU WANT TO GET/SET (This is an example, replace your desired inputs/outputs)
    ...
    # INITIALIZE OUTPUTS LISTS (This is an example, replace your desired outputs)
    ...
    for time_ in range(start_time, stop_time, step_size):
        ...
        X2 = fmu.getReal([vr_outputs[2]])[0]
        X3 = fmu.getReal([vr_outputs[3]])[0]
        X4 = fmu.getReal([vr_outputs[4]])[0]
        X0 = fmu.getReal([vr_outputs[0]])[0]
